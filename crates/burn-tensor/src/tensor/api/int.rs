...
impl<const D: usize> Tensor<D, Int> {
    ...
    ///
    /// Backends with an 8-bit GEMM (flex VNNI) can fuse the correction into the
    /// same kernel; others expand the algebraic identity.
    #[must_use]
    pub fn matmul_integer(self, other: Self, zp_lhs: Option<Self>, zp_rhs: Option<Self>) -> Self {
